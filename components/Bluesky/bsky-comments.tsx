...
export const CommentSection = ({ uri }) => {
  ...
  return (
    <Container>
      <div className="bg-laccent-2 dark:bg-daccent-2 rounded-2xl p-5 max-w-5xl mb-10 sm:mx-auto mx-1.5">
        ...
        <h2 className="mt-6 text-3xl font-bold">Comments</h2>
...
const Actions = ({ post }: { post: AppBskyFeedDefs.PostView }) => (
  <div className="mt-2 flex mb-2 w-full max-w-[150px] flex-row items-center justify-between opacity-60">

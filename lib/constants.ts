...
export const CMS_URL = 'https://wp.shaunguimond.com'
export const HOME_OG_IMAGE_URL =
  ...
  export const BSKY_AUTHOR_FEED = "https://public.api.bsky.app/xrpc/app.bsky.feed.getAuthorFeed?actor=shaunguimond.com&filter=posts_no_replies&limit=10"
